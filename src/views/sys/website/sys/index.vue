            ...
            <el-row>
              <el-col :span="11"><div>
                <el-form-item label="accessKeyId:">
                  <el-input style="width:450px;" type="password" v-model="formData.aliyunAccessKeyId" placeholder="请输入accessKeyId"></el-input>
                </el-form-item>
              </div></el-col>
              <el-col :span="11"><div>
                <el-form-item label="accessKeySecret:">
                  <el-input style="width:450px;" type="password" v-model="formData.aliyunAccessKeySecret" placeholder="请输入accessKeySecret"></el-input>
                </el-form-item>
              </div></el-col>
            </el-row>
            <el-row>
              <el-col :span="11"><div>
                <el-form-item label="ossUrl:">
                  <el-input style="width:450px;" type="password" v-model="formData.aliyunOssUrl" placeholder="请输入ossUrl"></el-input>
                </el-form-item>
              </div></el-col>
              <el-col :span="11"><div>
                <el-form-item label="ossBucket:">
                  <el-input style="width:450px;" type="password" v-model="formData.aliyunOssBucket" placeholder="请输入ossBucket"></el-input>
                </el-form-item>
              </div></el-col>
            </el-row>
            ...
            <el-row>
              <el-col :span="11"><div>
                <el-form-item label="smsCode:">
                  <el-input style="width:450px;" type="password" v-model="formData.smsCode" placeholder="请输入smsCode"></el-input>
                </el-form-item>
              </div></el-col>
              <el-col :span="11"><div>
                <el-form-item label="短信签名:">
                  <el-input style="width:450px;" type="password" v-model="formData.signName" placeholder="请输入短信签名"></el-input>
                </el-form-item>
              </div></el-col>
          </el-row>
          <el-row v-show="formData.fileType === 4">
