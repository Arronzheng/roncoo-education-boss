    ...
    export default {
        ...
        data() {
            return {
              rules: {
                  chapterName: [
                      { required: true, message: '请输入章节名称', trigger: 'blur', autocomplete: 'on' }
                  ]
              }
            }
        },
