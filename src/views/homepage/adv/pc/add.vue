      ...
      <el-form-item label="广告图片:" prop="advImg">
        <div>
          <el-upload
            ...
            <img v-if="advImg" :src="advImg" class="avatar" alt="">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // showPic(picAddress){
      //     this.formData.picAddress = picAddress
      //     // return '/course/pc/api/down/show?picAddress='+picAddress;
      //   apia.downPic(this.formData).then(response => {
      //       this.imgTest = response.data
      ...
      submitForm(formName) {
        if (this.formData === undefined) {
          ...
          if (!this.advImg) {
            ...
            this.formData.advImg = this.advImg
          }
